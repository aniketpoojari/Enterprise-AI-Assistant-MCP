...
class DatabaseManager:
    ...
    def execute_query(self, sql: str, params: tuple = (), max_rows: int = 100) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(error_msg)
            return {"error": error_msg, "sql": sql, "rows": [], "columns": [], "row_count": 0}
    ...
    def get_table_info(self, table_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            columns = [{"name": r["name"], "type": r["type"], "notnull": r["notnull"], "pk": r["pk"]} for r in cursor.fetchall()]
            ...
            return {"table_name": table_name, "columns": [], "row_count": 0, "error": str(e)}

    def get_sample_rows(self, table_name: str, limit: int = 5) -> Dict[str, Any]:
        """Get sample rows from a table."""
        return self.execute_query(f"SELECT * FROM '{table_name}' LIMIT ?", (limit,), max_rows=limit)
    ...
    def record_cost(self, request_id: str, query: str, model_name: str,
                    prompt_tokens: int, completion_tokens: int, total_tokens: int,
                    estimated_cost_usd: float, latency_ms: float = None,
                    tools_used: str = None, guardrail_flags: str = None,
                    success: bool = True):
